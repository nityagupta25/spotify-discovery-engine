...
def build_data(genres_sel, friends=None, n=10, seed=None):
    ...
    friends = [f for f in (friends or []) if f] or ["Nitya"]
...
const LINER_DATA = {
 ...
 "genres": ["Psych-pop","Indie","Lo-fi","Electronic","Hip-hop","Jazz"],
 "songs": [
  {"genre":"Psych-pop","artist":"Crumb","track":"Locket","origin":"Brooklyn","story":"Get ready to trip with Crumb's 'Locket', a swirling Brooklyn psych-pop track with infectious hooks.","trust":{"type":"friend","label":"Liked by Nitya"},"len":"2:17"},
  ...
  {"genre":"Indie","artist":"Men I Trust","track":"Show Me How","origin":"Montreal","story":"Men I Trust's 'Show Me How' is a laid-back Montreal indie gem with a soothing melody and gentle vibes.","trust":{"type":"friend","label":"Liked by Nitya"},"len":"2:38"},
  ...
  {"genre":"Lo-fi","artist":"Tom Misch","track":"It Runs Through Me","origin":"London","story":"Tom Misch's 'It Runs Through Me' is a laid-back London lo-fi track with soulful vocals and jazzy undertones.","trust":{"type":"friend","label":"Liked by Nitya"},"len":"2:59"},
  ...
  {"genre":"Electronic","artist":"Bonobo","track":"Kerala","origin":"UK","story":"Bonobo's 'Kerala' is an ethereal electronic journey with lush textures and a hypnotic beat.","trust":{"type":"friend","label":"Liked by Nitya"},"len":"2:20"},
  ...
  {"genre":"Hip-hop","artist":"Saba","track":"Sirens","origin":"Chicago","story":"Saba's 'Sirens' is a moody Chicago hip-hop track with a haunting hook and emotional depth.","trust":{"type":"friend","label":"Liked by Nitya"},"len":"2:41"},
  ...
  {"genre":"Jazz","artist":"GoGo Penguin","track":"Hopopono","origin":"Manchester","story":"GoGo Penguin's 'Hopopono' is a high-energy Manchester jazz track with a driving beat and soaring keys.","trust":{"type":"friend","label":"Liked by Nitya"},"len":"2:02"},
